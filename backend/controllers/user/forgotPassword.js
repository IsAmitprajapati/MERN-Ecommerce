              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    ...
                    <p style="margin:10px 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                    If you've lost your Password or wish to reset it,use the link below.
                    </p>
                    <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                        <a href="${process.env.FRONTEND_URL}/reset-password/${result._id}" style="color:#fff;background-color : rgb(233, 14, 14);padding: 10px 15px;border-radius : 3px;text-decoration : none;margin:10px 0 0 0 ">
                            Forgot Password
                        </a>
                    </p>
                  </td>
